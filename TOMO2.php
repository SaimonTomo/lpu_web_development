        ...
        <div style="margin-top:30px; margin-bottom:10px">
            <button id="search" type="submit" name="search_btn" class="btn btn-danger" style="padding:5px; margin- bottom:5px; margin-left:278px; width:130px">SEARCH</button>
                <select id="product_option" name="product_option" style="width:250px; height:36px; padding:5px">
                    <option value="TOMO2.php">select product</option>
            ...
            <form action = 'pagkain.php' method = 'POST'>
                ...
                <div class="pic_group"> 
                    <div class="pic_option"> 
                        <div>
                            <img src="drinks/20.jpg" data-toggle="tooltip" data-placement="top" title="Mirinda" alt="Mirinda">
                        </div>
                        <input type="checkbox" id="checkbox1" name="checkbox1" class="checkbox" onclick="handleCheckbox(this)"> Mirinda
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="drinks/d1.jpg" data-toggle="tooltip" data-placement="top" title="Coca Cola" alt="Coca Cola">
                        </div>
                        <input type="checkbox" id="checkbox2" name="checkbox2"class="checkbox" onclick="handleCheckbox(this)"> Coca Cola
                    </div>
                    <div class="pic_option">
                        <div>
                            <img src="drinks/d2.jpg" data-toggle="tooltip" data-placement="top" title="Mountain Dew" alt="Mountain Dew">
                        </div>
                        <input type="checkbox" id="checkbox3" name="checkbox3" class="checkbox" onclick="handleCheckbox(this)"> Mountain Dew
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="drinks/d3.jpg" data-toggle="tooltip" data-placement="top" title="Sunkist" alt="Sunkist">
                        </div>
                        <input type="checkbox" id="checkbox4" name="checkbox4">
                        <label for="checkbox4">Sunkist </label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="drinks/d4.jpg" data-toggle="tooltip" data-placement="top" title=" 7UP" alt=" 7UP">
                        </div>
                        <input type="checkbox" id="checkbox5" name="checkbox5">
                        <label for="checkbox5">7UP</label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="drinks/d5.jpg" data-toggle="tooltip" data-placement="top" title="Sprite" alt="Sprite">
                        </div>
                        <input type="checkbox" id="checkbox6" name="checkbox6">
                        <label for="checkbox6">Sprite </label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="drinks/d6.jpg" data-toggle="tooltip" data-placement="top" title="Pepsi" alt="Pepsi">
                        </div>
                        <input type="checkbox" id="checkbox7" name="checkbox7">
                        <label for="checkbox7">Pepsi </label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="drinks/d7.jpg" data-toggle="tooltip" data-placement="top" title="Minute Maid" alt="Minute Maid">
                        </div>
                        <input type="checkbox" id="checkbox8" name="checkbox8">
                        <label for="checkbox8">Minute Maid</label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="drinks/d8.jpg" data-toggle="tooltip" data-placement="top" title="Starry" alt="Starry">
                        </div>
                        <input type="checkbox" id="checkbox9" name="checkbox9">
                        <label for="checkbox9">Starry </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="drinks/d9.jpg" data-toggle="tooltip" data-placement="top" title="Fanta" alt="Fanta">
                        </div>
                        <input type="checkbox" id="checkbox10" name="checkbox10">
                        <label for="checkbox10">Fanta </label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="drinks/d10.jpg" data-toggle="tooltip" data-placement="top" title="RedBull" alt="RedBull">
                        </div>
                        <input type="checkbox" id="checkbox11" name="checkbox11">
                        <label for="checkbox11">RedBull </label>
                    </div>
                        <div class="pic_option"> 
                         <div>
                            <img src="drinks/d11.jpg" data-toggle="tooltip" data-placement="top" title="Tropicana" alt="Tropicana">
                        </div>
                        <input type="checkbox" id="checkbox12" name="checkbox12">
                        <label for="checkbox12">Tropicana </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="drinks/d12.jpg" data-toggle="tooltip" data-placement="top" title="Nestea" alt="Nestea">
                        </div>
                        <input type="checkbox" id="checkbox13" name="checkbox13">
                        <label for="checkbox13">Nestea </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="drinks/d13.jpg" data-toggle="tooltip" data-placement="top" title="Dr pepper" alt="Dr pepper">
                        </div>
                        <input type="checkbox" id="checkbox14" name="checkbox14">
                        <label for="checkbox14">Dr. Pepper </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="drinks/d14.jpg" data-toggle="tooltip" data-placement="top" title="Powerade" alt="Powerade">
                        </div>
                        <input type="checkbox" id="checkbox15" name="checkbox15">
                        <label for="checkbox15">Powerade </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="drinks/d15.jpg" data-toggle="tooltip" data-placement="top" title="Crush" alt="Crush">
                        </div>
                        <input type="checkbox" id="checkbox16" name="checkbox16">
                        <label for="checkbox16">Crush </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="drinks/d16.jpg" data-toggle="tooltip" data-placement="top" title="Gatorade" alt="Gatorade">
                        </div>
                        <input type="checkbox" id="checkbox17" name="checkbox17">
                        <label for="checkbox17">Gatorade </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="drinks/d17.jpg" data-toggle="tooltip" data-placement="top" title="New Coke" alt="New Coke">
                        </div>
                        <input type="checkbox" id="checkbox18" name="checkbox18">
                        <label for="checkbox18">New Coke </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="drinks/d18.jpg" data-toggle="tooltip" data-placement="top" title="Baileys" alt="Baileys">
                        </div>
                        <input type="checkbox" id="checkbox19" name="checkbox19">
                        <label for="checkbox19">Bailey's </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="drinks/c1.jpg" data-toggle="tooltip" data-placement="top" title="Coca Cola Life " alt="Coca Cola Life ">
                        </div>
                        <input type="checkbox" id="checkbox20" name="checkbox20">
                        <label for="checkbox20">Coca Cola Life </label>
                    </div>
                  </div>
                </div>
              </div>
