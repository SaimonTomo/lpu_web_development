...
<head>
 ...
 <script src="js/clothe.js"></script>
        ...
        <div style="margin-top:30px; margin-bottom:10px">
            <button id="search" type="submit" name="search_btn" class="btn btn-danger" style="padding:5px; margin- bottom:5px; margin-left:278px; width:130px">SEARCH</button>
                <select id="product_option" name="product_option" style="width:250px; height:36px; padding:5px">
                    <option value="TOMO5.php">select product</option>
            ...
            <form action = 'pagkain.php' method = 'POST'>
                ...
                <div class="pic_group"> 
                    <div class="pic_option"> 
                        <div>
                            <img src="clothe/c1.jpg" data-toggle="tooltip" data-placement="top" title="Adidas" alt="Adidas">
                        </div>
                    ...
                    <div class="pic_option"> 
                        <div>
                            <img src="clothe/c2.jpg" data-toggle="tooltip" data-placement="top" title="Calvin Klein" alt="Calvin Klein">
                        </div>
                        <input type="checkbox" id="checkbox2" name="checkbox2">
                        <label for="checkbox2">Calvin Klein </label>
                    </div>
                    <div class="pic_option">
                        <div>
                            <img src="clothe/c4.jpg" data-toggle="tooltip" data-placement="top" title="Patagonia" alt="Patagonia">
                        </div>
                        <input type="checkbox" id="checkbox3" name="checkbox3">
                        <label for="checkbox3">Patagonia </label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="clothe/c7.jpg" data-toggle="tooltip" data-placement="top" title="GAP" alt="GAP">
                        </div>
                        <input type="checkbox" id="checkbox4" name="checkbox4">
                        <label for="checkbox4">GAP </label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="clothe/c12.jpg" data-toggle="tooltip" data-placement="top" title="Gucci" alt="Gucci">
                        </div>
                        <input type="checkbox" id="checkbox5" name="checkbox5">
                        <label for="checkbox5">Gucci </label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="clothe/c10.jpg" data-toggle="tooltip" data-placement="top" title="Dolce & Gabanna" alt="Dolce & Gabanna">
                        </div>
                        <input type="checkbox" id="checkbox6" name="checkbox6">
                        <label for="checkbox6">Dolce & Gabanna </label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="clothe/c19.jpg" data-toggle="tooltip" data-placement="top" title="Nike" alt="Nike">
                        </div>
                        <input type="checkbox" id="checkbox7" name="checkbox7">
                        <label for="checkbox7">Nike </label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="clothe/c18.jpg" data-toggle="tooltip" data-placement="top" title="Christian Dior" alt="Christian Dior">
                        </div>
                        <input type="checkbox" id="checkbox8" name="checkbox8">
                        <label for="checkbox8">Christian Dior </label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="clothe/c20.jpg" data-toggle="tooltip" data-placement="top" title="Under Armour" alt="Under Armour">
                        </div>
                        <input type="checkbox" id="checkbox9" name="checkbox9">
                        <label for="checkbox9">Under Armour </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="clothe/cc8.jpg" data-toggle="tooltip" data-placement="top" title="Levis" alt="Levis">
                        </div>
                        <input type="checkbox" id="checkbox10" name="checkbox10">
                        <label for="checkbox10">Levi's </label>
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="clothe/c15.jpg" data-toggle="tooltip" data-placement="top" title="Hermes" alt="Hermes">
                        </div>
                        <input type="checkbox" id="checkbox11" name="checkbox11">
                        <label for="checkbox11">Hermes </label>
                    </div>
                        <div class="pic_option"> 
                         <div>
                            <img src="clothe/c13.jpg" data-toggle="tooltip" data-placement="top" title="Versace" alt="Versace">
                        </div>
                        <input type="checkbox" id="checkbox12" name="checkbox12">
                        <label for="checkbox12">Versace </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="clothe/zara.jpg" data-toggle="tooltip" data-placement="top" title="zara" alt="zara">
                        </div>
                        <input type="checkbox" id="checkbox13" name="checkbox13">
                        <label for="checkbox13">zara </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="clothe/champion.jpg" data-toggle="tooltip" data-placement="top" title="champion" alt="champion">
                        </div>
                        <input type="checkbox" id="checkbox14" name="checkbox14">
                        <label for="checkbox14">champion </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="clothe/uniqlo.jpg" data-toggle="tooltip" data-placement="top" title="uniqlo" alt="uniqlo">
                        </div>
                        <input type="checkbox" id="checkbox15" name="checkbox15">
                        <label for="checkbox15">uniqlo </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="clothe/rolex.jpg" data-toggle="tooltip" data-placement="top" title="rolex" alt="rolex">
                        </div>
                        <input type="checkbox" id="checkbox16" name="checkbox16">
                        <label for="checkbox16">rolex </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="clothe/anta.jpg" data-toggle="tooltip" data-placement="top" title="anta" alt="anta">
                        </div>
                        <input type="checkbox" id="checkbox17" name="checkbox17">
                        <label for="checkbox17">anta </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="clothe/cartier.jpg" data-toggle="tooltip" data-placement="top" title="cartier" alt="cartier">
                        </div>
                        <input type="checkbox" id="checkbox18" name="checkbox18">
                        <label for="checkbox18">cartier</label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="clothe/supreme.jpg" data-toggle="tooltip" data-placement="top" title="supreme" alt="supreme">
                        </div>
                        <input type="checkbox" id="checkbox19" name="checkbox19">
                        <label for="checkbox19">supreme </label>
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="clothe/burberry.jpg" data-toggle="tooltip" data-placement="top" title="burberry" alt="burberry">
                        </div>
                        <input type="checkbox" id="checkbox20" name="checkbox20">
                        <label for="checkbox20">burberry </label>
                    </div>
                  </div>
                </div>
              </div>
