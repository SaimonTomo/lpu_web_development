<?php
include 'process/registration_fill.php';
?>
...
<script src="js/emp_save.js"></script>
            ...
            <div class="container">
                <div class="page_border">
                    <form id="pic-upload" class="a-form" enctype="multipart/form-data" method="post" width='840'>
                        <h1 style="text-align:center;  font-size:47px; color:black"><b>Saimon's Employee Personal
                                Information</b></h1>
