        ...
        <div style="margin-top:30px; margin-bottom:10px">
            <button id="search" type="submit" name="search_btn" class="btn btn-danger" style="padding:5px; margin- bottom:5px; margin-left:278px; width:130px">SEARCH</button>
                <select id="product_option" name="product_option" style="width:250px; height:36px; padding:5px">
                    <option value="store.php">select product</option>
            ...
            <form action = 'pagkain.php' method = 'POST'>
                ...
                <div class="pic_group"> 
                    <div class="pic_option"> 
                        <div>
                            <img src="perfume/burberry.jpg" data-toggle="tooltip" data-placement="top" title="Burberry" alt="Burberry">
                        </div>
                        <input type="checkbox" id="checkbox1" name="checkbox1" class="checkbox" onclick="handleCheckbox(this)"> Burberry
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="perfume/7.jpg" data-toggle="tooltip" data-placement="top" title="Chanel" alt="Chanel">
                        </div>
                        <input type="checkbox" id="checkbox2" name="checkbox2" class="checkbox" onclick="handleCheckbox(this)"> Chanel
                    </div>
                    <div class="pic_option">
                        <div>
                            <img src="perfume/15.jpg" data-toggle="tooltip" data-placement="top" title="Chloe" alt="Chloe">
                        </div>
                        <input type="checkbox" id="checkbox3" name="checkbox3" class="checkbox" onclick="handleCheckbox(this)"> Chloe
                        
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="perfume/20.jpg" data-toggle="tooltip" data-placement="top" title="Polo" alt="Polo">
                        </div>
                        <input type="checkbox" id="checkbox4" name="checkbox4" class="checkbox" onclick="handleCheckbox(this)"> Polo
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="perfume/PERFUME_1.jpg" data-toggle="tooltip" data-placement="top" title="Christian Dior" alt="Christian Dior">
                        </div>
                        <input type="checkbox" id="checkbox5" name="checkbox5" class="checkbox" onclick="handleCheckbox(this)"> Christian Dior
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="perfume/PERFUME_2.webp" data-toggle="tooltip" data-placement="top" title="Gucci" alt="Gucci">
                        </div>
                        <input type="checkbox" id="checkbox6" name="checkbox6" class="checkbox" onclick="handleCheckbox(this)"> Gucci
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="perfume/p2.jpg" data-toggle="tooltip" data-placement="top" title="Marc Jacobs" alt="Marc Jacobs">
                        </div>
                        <input type="checkbox" id="checkbox7" name="checkbox7" class="checkbox" onclick="handleCheckbox(this)"> Marc Jacobs
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="perfume/13.jpg" data-toggle="tooltip" data-placement="top" title="Calvin Klein" alt="Calvin Klein">
                        </div>
                        <input type="checkbox" id="checkbox8" name="checkbox8" class="checkbox" onclick="handleCheckbox(this)"> Calvin Klein
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="perfume/9.jpg" data-toggle="tooltip" data-placement="top" title="Versace" alt="Versace">
                        </div>
                        <input type="checkbox" id="checkbox9" name="checkbox9" class="checkbox" onclick="handleCheckbox(this)"> Versace
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="perfume/8.jpg" data-toggle="tooltip" data-placement="top" title="Giorgio Armani" alt="Giorgio Armani">
                        </div>
                        <input type="checkbox" id="checkbox10" name="checkbox10" class="checkbox" onclick="handleCheckbox(this)"> Giorgio Armani
                    </div>
                    <div class="pic_option"> 
                        <div>
                            <img src="perfume/12.jpg" data-toggle="tooltip" data-placement="top" title="Givency" alt="Givency">
                        </div>
                        <input type="checkbox" id="checkbox11" name="checkbox11" class="checkbox" onclick="handleCheckbox(this)"> Givenchy
                    </div>
                        <div class="pic_option"> 
                         <div>
                            <img src="perfume/16.jpg" data-toggle="tooltip" data-placement="top" title="Mojave Ghost" alt="Mojave Ghost">
                        </div>
                        <input type="checkbox" id="checkbox12" name="checkbox12" class="checkbox" onclick="handleCheckbox(this)"> Mojave Ghost
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="perfume/PERFUME_4.webp" data-toggle="tooltip" data-placement="top" title="Bvlgari" alt="Bvlgari">
                        </div>
                        <input type="checkbox" id="checkbox13" name="checkbox13" class="checkbox" onclick="handleCheckbox(this)"> Bvlgari
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="perfume/6.jpg" data-toggle="tooltip" data-placement="top" title="Hugo" alt="Hugo">
                        </div>
                        <input type="checkbox" id="checkbox14" name="checkbox14" class="checkbox" onclick="handleCheckbox(this)"> Hugo
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="perfume/p1.jpg" data-toggle="tooltip" data-placement="top" title="Tomford" alt="Tomford">
                        </div>
                        <input type="checkbox" id="checkbox15" name="checkbox15" class="checkbox" onclick="handleCheckbox(this)"> Tomford
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="perfume/PERFUME_5.jpg" data-toggle="tooltip" data-placement="top" title="Creed Aventus" alt="Creed Aventus">
                        </div>
                        <input type="checkbox" id="checkbox16" name="checkbox16" class="checkbox" onclick="handleCheckbox(this)"> Creed Aventus
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="perfume/10.jpg" data-toggle="tooltip" data-placement="top" title="Hermes" alt="Hermes">
                        </div>
                        <input type="checkbox" id="checkbox17" name="checkbox17" class="checkbox" onclick="handleCheckbox(this)"> Hermes
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="perfume/11.jpg" data-toggle="tooltip" data-placement="top" title="Le Labo" alt="Le Labo">
                        </div>
                        <input type="checkbox" id="checkbox18" name="checkbox18" class="checkbox" onclick="handleCheckbox(this)"> Le Labo
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="perfume/17.jpg" data-toggle="tooltip" data-placement="top" title="Carolina" alt="Carolina">
                        </div>
                        <input type="checkbox" id="checkbox19" name="checkbox19" class="checkbox" onclick="handleCheckbox(this)"> Carolina
                    </div>
                        <div class="pic_option"> 
                        <div>
                            <img src="perfume/19.jpg" data-toggle="tooltip" data-placement="top" title="Saint Germain" alt="Saint Germain">
                        </div>
                        <input type="checkbox" id="checkbox20" name="checkbox20" class="checkbox" onclick="handleCheckbox(this)"> Saint Germain
                    </div>
                  </div>
                </div>
              </div>
